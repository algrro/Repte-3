...
function finishAudit() {
    ...
    resultDiv.innerHTML = `
        ...
        <button onclick="location.reload()" class="mt-4 px-6 py-3 font-semibold text-white bg-cheste-red rounded-full hover:bg-cheste-red-dark transition-colors">Tornar a l'inici</button>
    `;
